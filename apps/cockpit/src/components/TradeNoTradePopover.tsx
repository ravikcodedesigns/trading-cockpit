...
const ROWS: { window: string; lo: number; hi: number; cf: Cell; expl: Cell }[] = [
  { window: '09:30–09:53', lo: 570, hi: 594, cf: 'skip', expl: 'go'   },
  { window: '09:54–10:29', lo: 594, hi: 630, cf: 'go',   expl: 'go'   },
  { window: '10:30–11:29', lo: 630, hi: 690, cf: 'go',   expl: 'go'   },
  { window: '11:30–12:59', lo: 690, hi: 780, cf: 'go',   expl: 'go'   },
  { window: '13:00–14:29', lo: 780, hi: 870, cf: 'skip', expl: 'skip' },
  { window: '14:30–15:59', lo: 870, hi: 960, cf: 'skip', expl: 'go'   },
];
...
export function TradeNoTradePopover({ open, onToggle }: { open: boolean; onToggle: () => void }) {
  ...
  const cells = activeRow ? [activeRow.cf, activeRow.expl] : [];
    ...
    <div style={{ position: 'relative', display: 'inline-block' }}>
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            display: 'grid', gridTemplateColumns: '96px repeat(2, 1fr)',
